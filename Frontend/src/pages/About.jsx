...
// import whiteArrow from '../assets/icons/whitestraightArrow.svg'; // Ensuring the icon is imported
...
//             {/* Image */}
//             <div className="h-[500px] lg:h-[700px] lg:order-2 order-1">
//               <img 
...
//       {/* Testimonial Section */}
//       <section className="relative bg-[#2B0202] py-28 lg:py-40 overflow-hidden">
//         {/* Top Left Image - No gap, absolute positioning */}
//         <div className="hidden lg:block absolute top-0 left-0 w-[200px] xl:w-[280px] h-[400px] xl:h-[500px]">
//            <img 
//              src="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=800&auto=format&fit=crop" 
//              alt="Testimonial decoration left" 
//              className="w-full h-full object-cover" 
//            />
//         </div>

//         {/* Bottom Right Image - No gap, absolute positioning */}
//         <div className="hidden lg:block absolute bottom-0 right-0 w-[200px] xl:w-[280px] h-[400px] xl:h-[500px]">
//            <img 
//              src="https://images.unsplash.com/photo-1606800052052-a08af7148866?w=800&auto=format&fit=crop" 
//              alt="Testimonial decoration right" 
//              className="w-full h-full object-cover" 
//            />
//         </div>
...
//           {/* Testifier Name */}
//           <p 
//             className="font-lato text-[#FFFEFD] tracking-wide mb-16 uppercase"
//             style={{ 
...
//              {/* Button 1 */}
//              <button className="border border-[#FFFEFD] px-8 py-3 flex items-center justify-between gap-6 hover:bg-[#FFFEFD] hover:bg-opacity-10 transition-all duration-300">
//                 <span 
...
//                   View Our Portfolio
//                 </span>
//                 <img src={whiteArrow} alt="arrow" className="w-6 h-auto" />
//              </button>
...
//                   </span>
//                   <img 
//                     src={hoveredButton === 'portfolio' ? darkArrow : whiteArrow} 
//                     alt="" 
...
//                   </span>
//                   <img 
//                     src={hoveredButton === 'services' ? darkArrow : whiteArrow} 
//                     alt="" 
//                     className="w-5 h-auto transition-all duration-300" 
//                   />
//                </Link>
