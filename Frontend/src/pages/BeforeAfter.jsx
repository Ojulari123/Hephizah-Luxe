...
//               {/* Text Content */}
//               <div className={`${item.layout === 'right' ? 'lg:order-2' : 'lg:order-1'}`}>
...
//                 {/* Big Title - CENTERED */}
//                 <h2
//                   className="font-editors-note text-[#380F05] text-[30px] lg:text-[92px] mb-10 text-center"
...
//               {/* Comparison Slider */}
//               <div className={`${item.layout === 'right' ? 'lg:order-1' : 'lg:order-2'}`}>
//                 <ComparisonSlider
