...
//       {/* Services Section */}
//       <section className="relative bg-[#FFFEFD] pb-20 lg:pb-32">
...
//             {/* Overlapping Heading - positioned on top of image */}
//             <div className="absolute top-12 lg:top-20 left-8 lg:left-12">
//               <h2>
//                 {/* HOW WE - brown color */}
//                 <div className="mb-2">
//                   <span
...
//                 {/* you - white/cream color italic */}
//                 <div>
//                   <span
//                     className="font-editors-note italic block"
//                     style={{
//                       fontWeight: 1,
//                       fontSize: 'clamp(60px, 8vw, 120px)',
//                       lineHeight: '0.9',
...
//           {/* Right - Content */}
//           <div className="relative bg-[#FFFEFD] px-6 lg:px-16 py-16 lg:py-24 flex flex-col justify-center">

//             {/* Subheading */}
//             <h3 className="mb-8">
//               <span
//                 className="font-editors-note"
//                 style={{
//                   fontWeight: 1,
//                   fontSize: '45px',
//                   lineHeight: '50px',
...
//             <div className="space-y-6 mb-8">
//               <p
//                 className="font-newsreader text-[16px] lg:text-[18px]"
//                 style={{
//                   fontWeight: 200,
//                   lineHeight: '28px',
//                   color: '#380F05'
...
//             <Link
//               to="/services"
//               className="inline-flex items-center justify-center border px-6 py-3 transition-colors duration-300 group w-fit"
//               style={{
//                 borderColor: 'rgba(56, 15, 5, 0.8)'
//               }}
//             >
//               <span
//                 className="font-newsreader italic text-[18px] lg:text-[20px]"
//                 style={{
//                   fontWeight: 300,
//                   color: 'rgba(56, 15, 5, 0.8)'
//                 }}
//               >
