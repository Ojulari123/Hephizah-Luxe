    ...
    <div>
      ...
      <section className="relative w-full bg-[#2B0202] overflow-hidden">
        <div className="relative z-10 pt-20 lg:pt-16 pb-32 flex flex-col items-center">
          ...
          {/* Image Container 
        - Increased negative margin (mt-[-80px]) to pull the image up 
          slightly higher into the text for a tighter editorial look.
    */}
      ...
      <section className="bg-[#FFFEFD] py-16 lg:py-20 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-16">
            {categories.map((category) => (
              <button
                ...
                className={`font-lato text-[#380F05] transition-all ${activeCategory === category
          ...
          <div className="space-y-12">
            ...
            {filteredEvents.length > 3 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {filteredEvents.slice(3, 5).map((event, index) => (
                  <div key={index} className="group cursor-pointer">
                    <div className="overflow-hidden mb-4 aspect-[5/4]">
                      <img
                        src={event.image}
                        alt={event.title}
                        className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
            ...
            {/* Row 4 - 2 columns (if more events) */}
      ...
      <section className="relative bg-[#2B0202] py-24 lg:py-40 overflow-hidden">

        {/* Side Images - Kept narrow for the wider text layout */}
        <div className="hidden lg:block absolute top-20 left-0 w-[120px] xl:w-[180px] h-[450px] xl:h-[550px]">
          <img
        ...
        <div className="hidden lg:block absolute bottom-20 right-0 w-[120px] xl:w-[180px] h-[450px] xl:h-[550px]">
          <img
        ...
        {/* Content Container - Shifted more to the left */}
        <div className="max-w-7xl mx-auto px-6 lg:px-24 relative z-10 flex justify-start">
          <div className="max-w-4xl lg:ml-[100px] xl:ml-[140px]">

            {/* Header */}
            <h2
              className="font-editors-note text-[#FFFEFD] mb-6"
              style={{
                fontWeight: 1,
                fontSize: '40px',
                lineHeight: '100%'
            ...
            {/* CTA Line: Text and Button on the same line */}
            <div className="flex flex-col lg:flex-row lg:items-center gap-10">
              ...
              <Link
                ...
                className="inline-flex group border border-[#FFFEFD] px-8 py-3 items-center gap-8 transition-all duration-500 hover:bg-[#FFFEFD]"
              >
                <span
                  className={`font-newsreader italic transition-colors duration-500 ${hoveredButton === 'inquiry' ? 'text-[#2B0202]' : 'text-[#FFFEFD]'}`}
                  style={{
                    fontWeight: 300,
                    fontSize: '20px',
                    lineHeight: '35px'
                ...
                <img
                  src={hoveredButton === 'inquiry' ? straightArrow : whiteArrow}
                  alt="arrow"
