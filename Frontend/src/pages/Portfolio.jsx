...
//             {/* CTA Line: Text and Button opposite ends within text width */}
...
//               >
//                 <span
//                   className={`font-newsreader italic transition-colors duration-500 whitespace-nowrap ${hoveredButton === 'inquiry' ? 'text-[#2B0202]' : 'text-[#FFFEFD]'}`}
//                   style={{
//                     fontWeight: 300,
//                     fontSize: '20px',
//                     lineHeight: '35px'
